	 ...
	 function fun3(){
		 ...
		 if(obj.userid.value.length > 10 || obj.userid.value.length == 0){
			...
			return false;
			 ...
			 document.getElementById("alert_text").innerHTML=('<span style = "color : #777"><font color="green">허용 범위입니다.</font></span>'); 
	 ...
	 function fun4(){
		 ...
		 if(obj.nickname.value.length > 7 || obj.nickname.value.length == 0){
				...
				return false;
				 ...
				 document.getElementById("alert_name").innerHTML=('<span style = "color : #777"><font color="green">허용 범위입니다.</font></span>');
	 }
	 }
	 function fun5(){
		 var obj=document.jf;
		 if(obj.userpwd1.value=='' || obj.userpwd1.value != obj.userpwd.value){
				...
				return false;
				 ...
				 document.getElementById("alert_pwd").innerHTML=('<span style = "color : #777"><font color="green">입력한 패스워드가 일치합니다.</font></span>');
	 }
	 }
	 //모달창
		...
		<div id="member">
			...
			<div id="loginbar" style="vertical-align: middle">
				<%=member.getName()%>님 <a href="/YOLO/logout"><input id="logout"
					type="button" value="로그아웃"></a> <a href="/YOLO/myinfo"><input
